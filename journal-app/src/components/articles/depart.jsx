...
export default function Depart() {
    return (
        <>
            ...
            <p>J&#39;ai appris le HTML et CSS et des débuts de JavaScript après le lycée, en utilisant majoritairement les articles sur le site du <a href="https://developer.mozilla.org/en-US/">MDN</a> et en m&#39;entraînant sur des petits projets.</p>
