...
export default function TutoGame() {
    ...
    <>
        ...
        <h2><i>5 Février</i></h2>
        <p>Les 2 dernières semaines, j&#39;ai travaillée sur le <a target="_blank" href="https://react.dev/learn/tutorial-tic-tac-toe">tutoriel dans la documentation React</a> pour construire un jeu de tic tac toe.</p>
